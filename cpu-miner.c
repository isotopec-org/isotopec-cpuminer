...
static void show_credits()
{
   ...
   printf("    cpuminer-opt with YespowerIC and multi algorithm support.\n");
   printf("    Optimized for CPUs with AES_NI and AVX2 and SHA extensions.\n");
   printf("\n");
   printf("    IsotopeC Official Mining Pool: https://pool.isotopec.org/\n");
   printf("    Official Miner: https://github.com/isotopec-org/isotopec-cpuminer\n");
   printf("\n");
   printf("    Site: https://isotopec.org/\n");
   printf("    IsotopeC Blockchain Explorer: https://explorer.isotopec.org/\n");
   printf("\n");
   printf("    Discord Invite: https://discord.gg/BdDkEVZ\n");
   printf("    Bitcointalk ANN: https://bitcointalk.org/index.php?topic=5198654.0\n");
   printf("    Twitter: https://twitter.com/isotopec_org\n");
   printf("\n");
   printf("    Donate:\n");
   printf("    BTC: 1BTnzJcPmUYmNqnePTXbxCyrSasNpV2ZVV\n");
   printf("    ISO: iCJbPgNr8nm3kKi8p78TcFoHCaEYzXNo9J\n");
   printf("\n");
   printf("Live free and mine!\n");
   printf("-IsotopeCrypto\n");
   printf("\n");
   printf("    ( ͡° ͜ʖ ͡°)\n");
   printf("\n");
}
