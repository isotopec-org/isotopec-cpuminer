...
Name "isotopec-cpuminer v${MINER_VERSION}"
...
VIAddVersionKey CompanyName "IsotopeC Development Labs"
VIAddVersionKey LegalCopyright "2019 - IsotopeC Development Labs"
