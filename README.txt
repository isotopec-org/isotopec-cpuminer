...
isotopec-cpuminer is a console program that is executed from a DOS command prompt.
...
supported by isotopec-cpuminer due to an incompatible implementation of SSE2 on
